class ArrayUtils {
   ...
   * @return Array
   */
  static groupBy(arr: Array<Object>, by: string, unite: boolean = false): Array<Object> {
   ...
   * @return Array
   */
  static sortBy = (arr: Array<Object>, by: string, orderBy: 'DESC' | 'ASC' = 'ASC'): Array<Object> => {
    const arrClone = JSON.parse(JSON.stringify(arr));
   ...
   * @param orderBy 排序方式,DESC - 降序, ASC - 升序
   */
  static groupAndSort = (arr: Array<Object>, groupBy: string, sortBy: string, orderBy: 'DESC' | 'ASC' = 'ASC') => {
    const arrClone = JSON.parse(JSON.stringify(arr));
  ...
  static appendToParent(array: Array<any>, obj: Object, refKey: string, pKey: string) {
  ...
  static generateTree(array: Array<any>, options: {
    indexKey: string,
    rootVal: any,
    parentBy: string
  }) {
